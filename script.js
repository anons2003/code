document.addEventListener('DOMContentLoaded', function() {
    ...
    async function saveToMongoDB(responseType, value) {
        try {
    ...
    yesBtn.addEventListener('click', function() {
        // Save to MongoDB
        saveToMongoDB('yes_button', { answer: 'yes' });
    ...
    locationButtons.forEach(button => {
        ...
        button.addEventListener('click', function() {
            ...
            // Save to MongoDB
            saveToMongoDB('location_selection', { 
                location: this.dataset.location, 
                action: this.classList.contains('selected') ? 'selected' : 'deselected',
    ...
    confirmLocationBtn.addEventListener('click', function() {
        // Save to MongoDB
        saveToMongoDB('location_confirmed', { 
            selectedLocations: [...selectedLocations] 
        });
